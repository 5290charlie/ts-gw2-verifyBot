...
[b]Format:[/b] <Account Name> <API Key>
[b]Example:[/b] AccountName.1234 ABC12345-4991-9546-CB5B-78B015B0D8A72BC0E007-4FAF-48C3-9BF1-DA1OAD241266

Guild Wars 2 API keys can be created/deleted via ArenaNet site:
[url]https://account.arena.net/applications[/url]

[i][b]NOTE:[/b] API Key needs access to '[b]account[/b]' and '[b]character[/b]'[/i]
'''
...
bot_msg_success='''
  Authentication was succesful! Thank you. Have fun \(^.^)/
''' 

#Message sent for failed verification
bot_msg_fail='''
Unfortantely your authentication failed. Ask the Teamspeak admin to review the logs.
    ~ Likely a bad API key or incorrect API settings. ( API Key needs access to '[b]account[/b]' and '[b]character[/b]' )

Guild Wars 2 API keys can be created/deleted via ArenaNet site:
[url]https://account.arena.net/applications[/url]
  
NOTE: API Key needs access to '[b]account[/b]' and '[b]character[/b]'
'''
...
[b]Format:[/b] <API Key>
[b]Example:[/b] ABC12345-4991-9546-CB5B-78B015B0D8A72BC0E007-4FAF-48C3-9BF1-DA1OAD241266
